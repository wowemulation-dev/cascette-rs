...
async fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    if duration.as_micros() < 1000 {  // Less than 1ms
    ...
    let cache_dir = dirs::cache_dir()
        .unwrap()
        .join("ngdp/ribbit/cached/us");
    
    println!("  Certificate: {}/certs-5168ff90af0207753cccd9656462a212b859723b-0.bmime", cache_dir.display());
