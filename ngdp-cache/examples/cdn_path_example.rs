...
async fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    println!("  CDN URL: http://{{cdn_host}}/{{product_path}}/config/{}/{}/{}",
        &build_config[0..2], &build_config[2..4], build_config);
    println!("  Example: http://level3.blizzard.com/tpr/wow/config/{}/{}/{}",
        &build_config[0..2], &build_config[2..4], build_config);
    ...
    println!("  CDN URL: http://{{cdn_host}}/{{product_path}}/config/{}/{}/{}",
        &cdn_config[0..2], &cdn_config[2..4], cdn_config);
    println!("  Example: http://level3.blizzard.com/tpr/wow/config/{}/{}/{}",
        &cdn_config[0..2], &cdn_config[2..4], cdn_config);
    ...
    println!("  CDN URL: http://{{cdn_host}}/{{product_path}}/config/{}/{}/{}",
        &product_config[0..2], &product_config[2..4], product_config);
    println!("  Example: http://level3.blizzard.com/tpr/wow/config/{}/{}/{}",
        &product_config[0..2], &product_config[2..4], product_config);
    ...
    for host in &cdn_hosts {
        println!("  http://{}/tpr/wow/config/{}/{}/{}",
            host, &build_config[0..2], &build_config[2..4], build_config);
    }

    println!("\nCDN Config ({}):", cdn_config);
    for host in &cdn_hosts {
        println!("  http://{}/tpr/wow/config/{}/{}/{}",
            host, &cdn_config[0..2], &cdn_config[2..4], cdn_config);
    }

    println!("\nProduct Config ({}):", product_config);
    for host in &cdn_hosts {
        println!("  http://{}/tpr/wow/config/{}/{}/{}",
            host, &product_config[0..2], &product_config[2..4], product_config);
    }

    println!("\n=== Path Components Breakdown ===\n");
    println!("Pattern: http://{{cdn_host}}/{{product_path}}/{{content_type}}/{{hash[0:2]}}/{{hash[2:4]}}/{{hash}}");
