...
fn test_load_wow_classic_indices() {
    ...
    let config = CascConfig {
        data_path: PathBuf::from("/home/danielsreichenbach/Downloads/wow/1.13.2.31650.windows-win64/Data"),
        read_only: true,
        ..Default::default()
    };
...
fn test_load_wow_classic_era_indices() {
    ...
    let config = CascConfig {
        data_path: PathBuf::from("/home/danielsreichenbach/Downloads/wow/1.14.2.42597.windows-win64/Data"),
        read_only: true,
        ..Default::default()
    };
