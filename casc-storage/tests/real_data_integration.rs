...
fn test_load_wow_classic_era_indices() {
    ...
    println!("Testing with WoW Classic Era data at: {}", data_path.display());
...
fn test_load_any_wow_version() {
    ...
    println!("Testing with {} data at: {}", version.display_name(), data_path.display());
    ...
    println!("✓ Successfully loaded CASC storage for {}", version.display_name());
}
