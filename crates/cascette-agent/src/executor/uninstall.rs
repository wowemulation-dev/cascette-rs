...
//!
//! If another product shares the same install path, only product-specific
//! files are removed; the shared `Data/` directory is preserved.
...
/// Product-specific files removed on uninstall.
///
