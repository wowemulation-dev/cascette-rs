# Contributing to `cascette-rs`

Thank you for considering contributing to `cascette-rs`. We welcome community
...
Please report unacceptable behavior to [me](mailto:daniel@kogito.network).
...
- Check the [Issues](https://github.com/wowemulation-dev/cascette-rs/issues) tab
...
Name your branch descriptively, e.g., `add-casc-support` or
`fix-ribbit-parsing`.
...
2. **Create a Pull Request**: Go to the
   [repository page](https://github.com/wowemulation-dev/cascette-rs) and click
   "New Pull Request"
...
We are building a community based on these principles:
...
All contributions are valued. Contributors will be:
...
6. **Pull Request**: Asks the project maintainers to review and merge your
...
Thank you for contributing to `cascette-rs`. Your contributions help improve
this project. If you have questions or need assistance, reach out to us in the
Discord.
